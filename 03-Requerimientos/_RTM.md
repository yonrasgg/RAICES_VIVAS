...
| RF | Caso de Uso | Módulo | Actor Principal | MoSCoW | CU Expandido |
|----|------------|--------|-----------------|--------|-------------|
| RF-EDU-01 | CU-EDU-01: Registrar docente comunitario | EDU | Admin del sistema | Must | ✅ §4.1 |
| RF-EDU-02 | CU-EDU-02: Registrar estudiante | EDU | Docente comunitario | Should | — |
| RF-EDU-03 | CU-EDU-03: Cargar material educativo multimedia | EDU | Docente comunitario | Must | ✅ §4.2 |
| RF-EDU-04 | CU-EDU-04: Organizar material por asignatura | EDU | Docente comunitario | Should | — |
| RF-EDU-05 | CU-EDU-05: Realizar ejercicio de práctica | EDU | Estudiante | Should | — |
| RF-EDU-06 | CU-EDU-06: Consultar progreso de estudiante | EDU | Docente comunitario | Could | — |
| RF-SAB-01 | CU-SAB-01: Registrar saber ancestral multimedia | SAB | Guía cultural | Must | ✅ §4.3 |
| RF-SAB-02 | CU-SAB-02: Clasificar saber por categoría | SAB | Admin comunitario | Should | — |
| RF-SAB-03 | CU-SAB-03: Buscar saberes por filtros | SAB | Usuario autorizado | Should | — |
| RF-SAB-04 | CU-SAB-04: Configurar restricción de acceso | SAB | Admin comunitario | Must | ✅ §4.4 |
| RF-SAB-05 | CU-SAB-05: Registrar consentimiento informado | SAB | Admin comunitario | Must | — |
| RF-SAL-01 | CU-SAL-01: Registrar paciente con ID único | SAL | Auxiliar de salud | Must | ✅ §4.5 |
| RF-SAL-02 | CU-SAL-02: Registrar historial médico básico | SAL | Auxiliar de salud | Must | ✅ §4.6 |
| RF-SAL-03 | CU-SAL-03: Programar cita médica | SAL | Auxiliar de salud | Should | — |
| RF-SAL-04 | CU-SAL-04: Gestionar brigada de salud | SAL | Auxiliar de salud | Could | — |
| RF-SAL-05 | CU-SAL-05: Configurar alerta de seguimiento | SAL | Auxiliar de salud | Should | — |
| RF-TRANS-01 | CU-TRANS-01: Sincronizar datos offline/online | TRANS | Sistema / Usuario | Must | ✅ §4.7 |
| RF-TRANS-02 | CU-TRANS-02: Seleccionar idioma de interfaz | TRANS | Usuario autenticado | Must | ✅ §4.8 |
| RF-TRANS-03 | CU-TRANS-03: Configurar gobernanza de datos | TRANS | Admin comunitario | Must | — |
